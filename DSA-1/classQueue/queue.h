...
public:
    ...
    /// Оператор присваивания копированием, other - копируемый объект, возвращает ссылку на изменённый исходный объект
    Queue& operator=(const Queue& other) = default;

    /// Конструктор перемещения, other - rvalue ссылка на перемещаемый объект
    Queue(Queue&& other) noexcept = default;

    /// Оператор присваивания перемещением, other - rvalue ссылка на перемещаемый объект, возвращает ссылку на изменённый исходный объект
